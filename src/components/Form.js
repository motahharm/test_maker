    ...
    render() {
        return (
            <div className="Form container py-5">
                ...
                <textarea className="question form-control" placeholder="Content of question"
                value={this.state.question} 
                onChange={(e) => this.setState({ question: e.target.value })}
                ></textarea>
                <br />
                {/* Textfield for content of answer1 */}
                <input className="answer1 form-control" placeholder="Content of answer1"
                value={this.state.answer1}
                onChange={(e) => this.setState({ answer1: e.target.value })}
                ></input>
                <br />
                {/* Textfield for content of answer2 */}
                <input className="answer2 form-control" placeholder="Content of answer2"
                value={this.state.answer2}
                onChange={(e) => this.setState({ answer2: e.target.value })}
                ></input>
                <br />
                {/* Textfield for content of answer3 */}
                <input className="answer3 form-control" placeholder="Content of answer3"
                value={this.state.answer3}
                onChange={(e) => this.setState({ answer3: e.target.value })}
                ></input>
                <br />
                {/* Textfield for content of answer4 */}
                <input className="answer4 form-control" placeholder="Content of answer4"
